...
A fully working codebase is [here](https://github.com/dstroot/react-infinite-scroll).
...
<Step
  number={2}
  title="When the page changes run the effect and get more photos!"
/>
