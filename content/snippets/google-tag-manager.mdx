...
Create an account, or use an existing account, at [Google Tag Manager](https://tagmanager.google.com). (A new container is created by default, and you can create additional containers within each account.)
