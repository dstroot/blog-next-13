...
I would argue that the ability to react to change is a stronger indicator of success than the ability to create and follow long-term strategic plans. The world is just too complex and unpredictable. Responding to such a world requires greater adaptability, and adaptability is not a characteristic of long-term strategies and top-down hierarchies.
...
Alongside an "intelligence system" organizations will have to develop a new paradigm of personal leadership. The role of the senior leader must change - it is no longer centered on command and control. It is analogous to a "gardener" and an empathetic crafter of culture, rather than a task master. A gardener cannot actually “grow” tomatoes, squash, or beans — they can only foster an environment for the plants do so.

In addition to giving teams a real-time understanding of what is happening in the world, we need senior leaders to provide them a clear and unambiguous sense of "mission" and purpose. Instead of cascading goals, instead of cascading instructions for actions, we must cascade trust, meaning, purpose and focus down to our employees. We must foster the right environment for them to react in real-time.
