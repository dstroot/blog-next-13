...
Another organization I worked with created a three-year strategic vision and uses a rolling eighteen-month budget. Every six months the budget is be adjusted and re-forecasted. The strategic vision would be accelerated in favorable times and delayed in lean times to match market conditions. This organization adapts much better to changes in market conditions than most. However, there is an even better way to improve agility and resilience we will discuss below.
...
I would argue that the ability to react to change is a stronger indicator of success than the ability to create and follow long-term strategic plans. Today's world is just too complex and unpredictable. Responding to such a world requires greater adaptability, and adaptability is not a characteristic of long-term strategies and top-down hierarchies.
...
This approach allowed US forces to be as resilient and agile as our enemy. We were now winning because we could be as fast as the world around us. As a result of his leadership of JSOC, and his outstanding results, General McChrystal was appointed to lead all US forces in Afghanistan in 2009 as Commander, United States Forces – Afghanistan (USFOR-A).

## Planning is Good, Reacting is Better

Alongside an "intelligence system" organizations will have to develop a new paradigm of personal leadership. The role of the senior leader must change. It is analogous to a "gardener" and an empathetic crafter of culture, not a task master. A gardener cannot actually “grow” tomatoes, squash, or beans — they can only foster an environment in which the plants do so.

In addition to giving our teams and their members a real-time understanding of what is happening in the world, we need to provide them a clear and unambiguous sense of purpose. Instead of cascading goals, instead of cascading instructions for actions, we must cascade trust, meaning, purpose and focus down to our employees.

It’s not true that the best plan wins. The organizations best able to adapt to their environment win. The best companies don’t just cascade _goals_; the best organizations cascade _trust, meaning, focus, purpose and information_ because the best intelligence wins, as long as it can be acted upon on the front lines.
