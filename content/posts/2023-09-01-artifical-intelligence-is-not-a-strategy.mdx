...
If you read the news covering artificial intelligence (AI) developments on any given day, you may feel pangs of fear and dread. It seems like the technology has evolved so rapidly that it will be difficult to "catch up", let alone "keep up".

However on the postive side those AI startups are targeting making AI technology accessible and usable for enterprise customers.

## <a name='2'></a>Finding your highest opportunity AI use cases

Unless your business directly revolves around Artificial Intelligence (e.g., OpenAI) AI is not a "strategy". It is much better the consider what your actual strategies are, and then how to apply AI to better acheive those strategies.

It Is a Customer Experience Accelerator
