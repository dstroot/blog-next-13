...
export const StylishSearchBox = (props: StylishSearchBoxProps) => {
  return (
    <div className="my-6 flex w-full justify-center md:my-12">
      <div className="z-10 flex max-w-[90vw] gap-2 rounded-full bg-zinc-900 px-2 py-[2px] shadow-lg shadow-black/40 dark:bg-zinc-200 dark:shadow-white/40">
        <div className="flex min-w-0 flex-1 items-center self-end">
          <form className="h-full w-full [&_textarea]:pr-11">
            <div className="relative flex h-fit min-h-full w-full items-center">
              ...
              <div className="relative flex min-w-0 flex-1 self-start">
                <textarea
                  maxLength={1000}
                  className="resize-none border-0 bg-transparent py-3 pl-3 text-base text-white shadow-none outline-none ring-0 [scroll-padding-block:0.75rem] selection:bg-teal-300 selection:text-black placeholder:text-zinc-300 disabled:bg-transparent disabled:opacity-80 dark:text-black dark:placeholder:text-zinc-700 sm:min-w-[50vw] md:text-lg"
                  spellCheck="false"
                  rows={1}
                  placeholder="Search..."
                  autoFocus
